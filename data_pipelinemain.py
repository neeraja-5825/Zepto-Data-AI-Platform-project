  ...
  "cells": [
    {
      ...
      "metadata": {
        ...
        "id": "HPBklyAntLJW",
        "outputId": "6435a183-35c6-4346-acd1-c7c1fa7c4af2"
      },
      "execution_count": 3,
      "outputs": [
        {
          ...
          "text": [
            ...
            "scraping Travel -> http://books.toscrape.com/catalogue/category/books/travel_2/index.html\n",
            "got 11 from Travel\n",
            "scraping Mystery -> http://books.toscrape.com/catalogue/category/books/mystery_3/index.html\n",
            "got 32 from Mystery\n",
            "scraping Historical Fiction -> http://books.toscrape.com/catalogue/category/books/historical-fiction_4/index.html\n",
            "got 26 from Historical Fiction\n",
            "total scraped 69\n",
            "\n",
            "--- cleaning ---\n",
            "nulls before {'title': 0, 'price_text': 0, 'star_text': 0, 'availability_text': 0, 'category': 0, 'price_gbp': 0, 'rating': 0, 'in_stock': 0}\n",
            "after clean shape (69, 8)\n",
            "converted using fixed rate 105.5\n",
            "db created with 2 tables PK FK\n",
            "\n",
            "--- q1_select_where ---\n",
            "SELECT title, price_gbp FROM books WHERE price_gbp > 30;\n",
            "[(\"It's Only the Himalayas\", 45.17), ('Full Moon over Noahâ\\x80\\x99s Ark: An Odyssey to Mount Ararat and Beyond', 49.43), ('See America: A Celebration of Our National Parks & Treasured Sites', 48.87), ('Vagabonding: An Uncommon Guide to the Art of Long-Term World Travel', 36.94), ('Under the Tuscan Sun', 37.33)]\n",
            "\n",
            "--- q2_order_by_limit ---\n",
            "SELECT title, rating FROM books ORDER BY rating DESC LIMIT 10;\n",
            "[('1,000 Places to See Before You Die', 5), ('A Time of Torment (Charlie Parker #14)', 5), ('What Happened on Beale Street (Secrets of the South Mysteries #2)', 5), (\"The Bachelor Girl's Guide to Murder (Herringford and Watts Mysteries #1)\", 5), ('The Silkworm (Cormoran Strike #2)', 5)]\n",
            "\n",
            "--- q3_distinct ---\n",
            ...
            "\n",
            "--- q4_in_between ---\n",
            "SELECT title, price_gbp FROM books WHERE rating IN (4,5) AND price_gbp BETWEEN 20 AND 50;\n",
            "[('Full Moon over Noahâ\\x80\\x99s Ark: An Odyssey to Mount Ararat and Beyond', 49.43), ('1,000 Places to See Before You Die', 26.08), ('Sharp Objects', 47.82), ('The Murder of Roger Ackroyd (Hercule Poirot #4)', 44.1), ('A Time of Torment (Charlie Parker #14)', 48.35)]\n",
            "\n",
            "--- q5_join ---\n",
            "SELECT c.category_name, b.title, b.rating, b.price_inr FROM books b JOIN categories c ON b.category_id = c.category_id ORDER BY c.category_name, b.rating DESC LIMIT 10;\n",
            "[('Historical Fiction', 'A Flight of Arrows (The Pathfinders #2)', 5, 5858.42), ('Historical Fiction', 'Mrs. Houdini', 5, 3191.38), ('Historical Fiction', 'The Passion of Dolssa', 5, 2987.76), ('Historical Fiction', 'Voyager (Outlander #3)', 5, 2222.89), ('Historical Fiction', 'The Red Tent', 5, 3762.13)]\n",
            "\n",
            "--- pd.read_sql join ---\n",
            "  category_name                                              title  rating  \\\n",
            "0        Travel                            It's Only the Himalayas       2   \n",
            "1        Travel  Full Moon over Noahâs Ark: An Odyssey to Mou...       4   \n",
